var colors = require('colors'),
    ...
    utils = require('./../utils'),
    zmq = require('zeromq'),
    server = config.exchanges.xm.pricing_server,
    port_prefix = config.exchanges.xm.port_prefix,
    enabled = config.exchanges.xm.enabled,
    debug = config.exchanges.xm.debug,
    exchangeRef = config.exchanges.xm.name;

module.exports = {

    exchangeName: config.exchanges.xm.name,

    markers: config.exchanges.xm.symbols,
