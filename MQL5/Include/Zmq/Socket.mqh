...
public:
   ...
   string            recv(ZmqMsg &msg,bool nowait=false);
...
string Socket::recv(ZmqMsg &msg,bool nowait=false)
  {
   ...
   if( zmq_msg_recv(msg,m_ref,flags) ) {
      message = _ptr2str(zmq_msg_data(msg));
   }
   return message;
  }
